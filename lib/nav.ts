...
export const navItems: NavItem[] = [
  ...
  { href: "/internships", label: "Internships", icon: Briefcase, section: "Professional" },
  { href: "/volunteer", label: "Volunteer", icon: HeartHandshake, section: "Professional" },
  ...
  { href: "/conferences", label: "Conferences", icon: Presentation, section: "Credentials" },

  { href: "/skills", label: "Skills", icon: Sparkles, section: "Profile" },
  { href: "/reading", label: "Reading Log", icon: BookMarked, section: "Profile" },
