...
export const entities: Record<string, EntityConfig> = {
  ...
  project: {
    ...
    fields: [
      ...
      { name: "course", label: "Course", type: "text", required: true, placeholder: "e.g. PSY 320" },
      { name: "date", label: "Date", type: "text", required: true, placeholder: "e.g. Nov 2025" },
      { name: "grade", label: "Grade", type: "text", required: true, placeholder: "A" },
      ...
      { name: "submissionVideo", label: "Project submission — Video file (optional)", type: "video", help: "Upload a .mov, .mp4, or .webm — any length. Uploads go straight to Vercel Blob (bypass the serverless limit)." },
      { name: "submissionVideoUrl", label: "Project submission — Video link (optional)", type: "url", help: "Or paste an unlisted YouTube, Vimeo, or Google Drive link." },
    ],
  },
  paper: {
    key: "paper",
